<template>
	<div>
		...
		<el-row style="height: 240px;margin-top: 10px;border: 1px solid #f0eff5;">
			...
			<el-col :span="16" style="">
				...
				<el-row class="dev-set-list-item">
					...
					<el-col :span="3" class="align-right">
						<!-- 	<el-radio v-model="radio" label="1">{{$t('commons.open')}}</el-radio>
						<el-radio v-model="radio" label="2">{{$t('commons.close')}}</el-radio> -->
						<el-switch v-model="phone_arm_switch" active-color="#13ce66"></el-switch>
					</el-col>
				</el-row>
				<!-- 系统信息 -->
				<el-row class="dev-set-list-item">
					...
					<el-col :span="3" class="align-right">
						<!-- 				<el-radio v-model="radio" label="1">{{$t('commons.open')}}</el-radio>
						<el-radio v-model="radio" label="2">{{$t('commons.close')}}</el-radio> -->
						<el-switch v-model="phone_sys_switch" active-color="#13ce66"></el-switch>
					</el-col>
				</el-row>
				<!-- 系统报警 -->
				<el-row class="dev-set-list-item">
					...
					<el-col :span="3" class="align-right">
						<!-- 			<el-radio v-model="radio" label="1">{{$t('commons.open')}}</el-radio>
						<el-radio v-model="radio" label="2">{{$t('commons.close')}}</el-radio> -->
						<el-switch v-model="phone_alarm_switch" active-color="#13ce66"></el-switch>
					</el-col>
				</el-row>
			</el-col>
