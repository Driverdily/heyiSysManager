	...
	<div>
		...
		<el-row class="dev-set-list-item">
			<el-col :span="2" style="align-items: center;">
				<img src="../../../assets/img/seticon/message.png" class="dev-set-list-img">
			</el-col>
			<el-col :span="7">
				<span>{{$t('rfid_phone')}}</span>
			</el-col>
			<el-col :span="12">
		...
		<el-row class="dev-set-list-item">
			...
			<el-col :span="16">
				<span>{{$t('rfid_function')}}</span>
			</el-col>
			<el-col :span="8" class=" align-right">
				<el-select v-model="rfid_value" keep-alive size="mini" :placeholder="$t('select')" style="width: 90%;">
