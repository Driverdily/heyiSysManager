...
<script>
import { geoCoordMap } from "../../../tools/chinaMap";
  ...
  methods: {
          ...
          },
          {
            ...
            data: item[1].map(function (dataItem) {
              return {
                ...
                value: that.mapData[dataItem[1].name].concat([
                  dataItem[1].value,
                ]),
              };
            }),
    ...
    chartInit() {
      let myChart = this.$echarts.init(
        document.getElementById("chinaMapChart")
      );
      myChart.setOption({
        ...
        tooltip: {
          ...
          formatter: function (params) {
            if (params.seriesType == "effectScatter") {
              return "设备：" + params.data.name + "" + params.data.value[2];
