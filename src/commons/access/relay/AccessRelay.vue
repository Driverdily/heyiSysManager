	...
	<div>
		<el-row style="height: 530px;border: 1px solid gray;margin: 1px;">
			<el-col :span="8" style="height: 100%;overflow: scroll;">
				<el-table ref="singleTable" :data="ZoneList" style="width: 100% ;" size="mini" highlight-current-row
				...
				<el-row class="dev-set-list-item">
					...
					<el-col :span="11" class="align-right">
						<el-select v-model="relay_type_value" keep-alive size="mini" :placeholder="$t('commons.select')" style="width: 90%;">
							<el-option v-for="item in RelayTypeList" :key="item.value" :label="item.label" :value="item.value">
							</el-option>
						</el-select>
					</el-col>
				</el-row>
				...
				<el-row class="dev-set-list-item">
					...
					<el-col :span="11" class="align-right">
						<el-select v-model="output_type_value" keep-alive size="mini" :placeholder="$t('commons.select')" style="width: 90%;"
						 :disabled="this.relay_type_value==1">
							<el-option v-for="item in RelayOutputTypeList" :key="item.value" :label="item.label" :value="item.value">
							</el-option>
						</el-select>
					</el-col>
				</el-row>
					...
					<el-col :span="11" class="align-right">
						<el-select v-model="zone_mode_value" keep-alive size="mini" :placeholder="$t('commons.select')" style="width: 90%;"
						 :disabled="this.relay_type_value==0">
							<el-option v-for="item in ZoneModeList" :key="item.value" :label="item.label" :value="item.value">
							</el-option>
						</el-select>
					</el-col>
				</el-row>
